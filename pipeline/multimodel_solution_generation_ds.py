        ...
        while idx < len(self.final_dataset):
            ...
            with open(opts.output_file, "a") as f:
                for i in range(len(chunk)):                    
                    ...
                    chunk[i]["prompt_1"] = prompts[i*self.K]
                    chunk[i]["prompt_2"] = prompts[i*self.K + 1]
                    chunk[i]["solution_1"] = results[i*self.K]['response'].strip()
                    chunk[i]["solution_2"] = results[i*self.K + 1]['response'].strip()
...
if __name__ == "__main__":
    ...
    opts_dict = {
        ...
        "output_file": "data/multimodal/generated_solutions_ds.jsonl"
    }
